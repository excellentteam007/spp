...
class UiUtil:
    ...
    from WTFV1.tools.comm_util import LogUtil
    ...
    def get_driver(cls):
        ...
        page = FileUtil.get_ini_value('..\\conf\\base.ini', 'ui_info', 'login_page')
    ...
    def mouse_hover(self, driver, element):
        """
        鼠标悬停操作
        :param driver: 浏览器驱动
        :param element: 元素定位
    ...
    def execute_js(self, driver, js_code):
        """
        执行js代码
        :param driver:浏览器驱动
        :param js_code:js代码
